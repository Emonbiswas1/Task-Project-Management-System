...
function create_user_by_admin($conn, $name, $email, $password_hash, $role, $phone, $company_name) {
    ...
    mysqli_stmt_bind_param($stmt, "ssssss", $name, $email, $password_hash, $role, $phone, $company_name);
...
function get_all_users_for_admin($conn) {
    $sql = "SELECT * FROM users 
            ORDER BY created_at DESC";
